...
export default function Navigation() {
  ...
  return (
    <Disclosure as="nav" className="bg-blue-base">
      {({ open }) => (
        <>
          <div className="mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
                      ...
                      <Link passHref href={item.href} key={item.name}>
                        <a
                          className={classNames(
                            item.current
                              ? 'bg-blue-btn-base hover:bg-blue-btn-hover text-white'
                              : 'bg-blue-btn-base hover:bg-blue-btn-hover text-white',
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                >
                  Help &amp; Support
                  <div className="cursor-pointer text-primary-white w-4 h-auto ml-2">
                    <ChevronDownIcon />
                  </div>
                </a>
                <div className="h-4 border-l border-secondary-lightgray mx-2 opacity-10" />
                <VersionBox theme="dark" />
                <div className="h-4 border-l border-secondary-lightgray mx-8 opacity-10" />
                <div className="cursor-pointer text-white w-4 h-auto mr-4">
                  <BellIcon />
                </div>
                {/* Profile dropdown */}
                <Menu as="div" className="ml-3 relative">
                  <div>
                    <Menu.Button className="bg-transparent flex text-sm items-center text-white">
